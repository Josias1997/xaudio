...
public final class ToolbarContentTintHelper {
        ...
        public static void colorBackButton(@NonNull Toolbar toolbar) {
            int color = AppThemeUtil.INSTANCE.resolveColor(toolbar.getContext(), androidx.appcompat.R.attr.colorControlNormal);
        ...
        public static void colorizeToolbar(Toolbar toolbarView, int toolbarIconsColor,
            ...
            for (int i = 0; i < toolbarView.getChildCount(); i++) {
                ...
                toolbarView.setTitleTextColor(AppThemeUtil.INSTANCE.resolveColor(activity, android.R.attr.textColorPrimary));
                toolbarView
                        .setSubtitleTextColor(AppThemeUtil.INSTANCE.resolveColor(activity, android.R.attr.textColorSecondary));
