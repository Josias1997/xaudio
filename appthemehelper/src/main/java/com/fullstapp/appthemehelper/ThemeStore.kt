package com.fullstapp.appthemehelper
...
class ThemeStore private constructor(private val mContext: Context) : ThemeStorePrefKeys, ThemeStoreInterface {
    ...
    override fun primaryColor(color: Int): ThemeStore {
        ...
        if(Companion.autoGeneratePrimaryDark(mContext)) {
    ...
    companion object {
        ...
        fun coloredStatusBar(context: Context): Boolean {
            return prefs(context).getBoolean(
                ThemeStorePrefKeys.KEY_APPLY_PRIMARY_DARK_STATUS_BAR,
                true
            )
        }
