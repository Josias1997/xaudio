...
public final class TintHelper {
        ...
        try {
            ...
            for (int i = 0; i < handleNames.length; i++) {
                ...
                if (handleDrawable == null) {
                    ...
                    handleDrawable = ResourcesCompat.getDrawable(view.getResources(), resId, null);
                }
    ...
    public static void setTintAuto(final @NonNull View view, final @ColorInt int color,
                                   boolean background) {
        setTintAuto(view, color, background, AppThemeUtil.INSTANCE.isWindowBackgroundDark(view.getContext()));
    }
