## **Q: How do I get the beta version of Xaudio?**
...
Make sure to switch and use your account in the Play Store app through which you purchased before installing Xaudio. The Google account used to install the app is also used to purchase/restore the pro license.
...
There are three methods for adding offline synced lyrics in Xaudio.
...
#### STEP 3: 
Open Xaudio and head to the song synced lyrics editor.
#### STEP 4: 
...
- The Xaudio in-built equalizer was removed updates ago so the only equalizer you will have by your OEM or Android native equalizer which isn't made by us and have no control over them. So you can report those issues to your OEM so that they can provide a fix in the next updates.
...
Settings -> Personalize -> Fullscreen controls -> Enable (this will only be visible when songs are playing from Xaudio).
___
...
Xaudio uses the native media player that comes with your Android phone, so as long as a file type is supported by your phone, it's supported by Xaudio.
___

## **Q: Why is my device slowing down when I'm using the app?**
Xaudio is image intensive, it keeps images in the cache for quick loading.
___

## **Q: The title "Xaudio" is showing on the top of the app, how can I fix this?** 
...
1. Then open the Xaudio app and manually scan your music from your storage. 

1. Reboot the device to refresh the media store (Not sure if this is necessary)

**NOTE:** Don't panic when you will open Xaudio and see "Zero" songs there in the library. It's because you cleared Media Store which is responsible for recognising files on your device.
___
...
- Xaudio's font has now been replaced with system font, which means the default font your system uses will be used by Xaudio too. It fixes all font-related issues you used to face/are facing in the app. 

- With the recent Xaudio v5 release, we have a built-in optional font "Manrope font" which you can toggle from Settings > Look & Feel > Toggle "Use manrope font".
...
In your built-in music player, there should be an option to save that playlist as a file. Save them and import them from the file manager by opening it into Xaudio.

> Note that such playlist must be of your offline music only since Xaudio is an offline music player, not an online music player. So if your playlist is of online music, it can't be opened on other offline players nor can be exported
___

## **Q: How to restore/import playlist?**
Xaudio will automatically detect any playlist file when that playlist file is stored in internal storage/Playlist. However, if it doesn't, just open any "File manager" and open that playlist file with Xaudio.
