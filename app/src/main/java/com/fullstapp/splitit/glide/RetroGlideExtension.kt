package com.fullstapp.splitit.glide
...
import com.fullstapp.splitit.App.Companion.getContext
import com.fullstapp.splitit.Constants.USER_BANNER
import com.fullstapp.splitit.Constants.USER_PROFILE
import com.fullstapp.splitit.R
import com.fullstapp.splitit.extensions.accentColor
import com.fullstapp.splitit.glide.artistimage.ArtistImage
import com.fullstapp.splitit.glide.audiocover.AudioFileCover
...
import com.fullstapp.splitit.util.ArtistSignatureUtil
import com.fullstapp.splitit.util.CustomArtistImageUtil.Companion.getFile
import com.fullstapp.splitit.util.CustomArtistImageUtil.Companion.getInstance
import com.fullstapp.splitit.util.MusicUtil.getMediaStoreAlbumCoverUri
...
object RetroGlideExtension {
    ...
    private val DEFAULT_ARTIST_IMAGE = R.drawable.default_artist_art
