...
class AppWidgetText : BaseAppWidget() {
    override fun defaultAppWidget(context: Context, appWidgetIds: IntArray) {
        ...
        appWidgetView.setImageViewBitmap(
            ...
            context.getTintedDrawable(
                R.drawable.ic_skip_next, ContextCompat.getColor(
                    context, com.fullstapp.appthemehelper.R.color.md_white_1000
                )
            ).toBitmap()
        )
        appWidgetView.setImageViewBitmap(
        ...
        appWidgetView.setTextColor(
            R.id.title,
            ContextCompat.getColor(context, com.fullstapp.appthemehelper.R.color.md_white_1000)
        )
        appWidgetView.setTextColor(
            R.id.text,
            ContextCompat.getColor(context, com.fullstapp.appthemehelper.R.color.md_white_1000)
        ...
        appWidgetView.setImageViewBitmap(
            ...
            service.getTintedDrawable(
                playPauseRes, ContextCompat.getColor(
                    service, com.fullstapp.appthemehelper.R.color.md_white_1000
                )
            ).toBitmap()
        )
        appWidgetView.setImageViewBitmap(
            ...
            service.getTintedDrawable(
                ...
                ContextCompat.getColor(
                    service,
                    com.fullstapp.appthemehelper.R.color.md_white_1000
                )
            ).toBitmap()
        )
        appWidgetView.setImageViewBitmap(
