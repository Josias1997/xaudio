 ...
 *
 */
package com.fullstapp.splitit.fragments.base
...
import com.fullstapp.splitit.activities.tageditor.SongTagEditorActivity
import com.fullstapp.splitit.db.PlaylistEntity
import com.fullstapp.splitit.db.toSongEntity
import com.fullstapp.splitit.dialogs.*
...
import com.fullstapp.splitit.interfaces.IPaletteColorHolder
...
import com.fullstapp.splitit.util.NavigationUtil
import com.fullstapp.splitit.util.PreferenceUtil
import com.fullstapp.splitit.util.RingtoneManager
...
abstract class AbsPlayerFragment(@LayoutRes layout: Int) : AbsMusicServiceFragment(layout),
    ...
    override fun onMenuItemClick(
        ...
        when (item.itemId) {
            R.id.action_split_audio -> {
                SplitAudioDialog.create(song).show(childFragmentManager, "SPLIT_AUDIO")
            }
