 ...
 *
 */
package com.fullstapp.splitit.fragments.player.flat
...
import com.fullstapp.splitit.databinding.FragmentFlatPlayerPlaybackControlsBinding
...
class FlatPlaybackControlsFragment :
    ...
    override fun setColor(color: MediaNotificationProcessor) {
        if (AppThemeUtil.isWindowBackgroundDark(requireContext())) {
