...
import com.fullstapp.splitit.databinding.FragmentMd3PlayerBinding
...
class MD3PlayerFragment : AbsPlayerFragment(R.layout.fragment_md3_player) {
    ...
    override fun toolbarIconColor(): Int {
        return AppThemeUtil.resolveColor(requireContext(), androidx.appcompat.R.attr.colorControlNormal)
    }
    ...
    override fun onColorChanged(color: MediaNotificationProcessor) {
        ...
        ToolbarContentTintHelper.colorizeToolbar(
            ...
            AppThemeUtil.resolveColor(requireContext(), androidx.appcompat.R.attr.colorControlNormal),
            requireActivity()
        )
    }
