...
public class BreadCrumbLayout extends HorizontalScrollView implements View.OnClickListener {
    ...
    private void init() {
        contentColorActivated =
                AppThemeUtil.INSTANCE.resolveColor(getContext(), android.R.attr.textColorPrimary);
        contentColorDeactivated =
                AppThemeUtil.INSTANCE.resolveColor(getContext(), android.R.attr.textColorSecondary);
