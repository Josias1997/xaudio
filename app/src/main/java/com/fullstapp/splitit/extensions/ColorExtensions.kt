...
import com.fullstapp.appthemehelper.ThemeStore
...
import com.fullstapp.splitit.util.PreferenceUtil.materialYou
...
fun Toolbar.backgroundTintList() {
    val surfaceColor =
        AppThemeUtil.resolveColor(context, com.google.android.material.R.attr.colorSurface, Color.BLACK)
...
fun Context.resolveColor(@AttrRes attr: Int, fallBackColor: Int = 0) =
    AppThemeUtil.resolveColor(this, attr, fallBackColor)

fun Fragment.resolveColor(@AttrRes attr: Int, fallBackColor: Int = 0) =
    AppThemeUtil.resolveColor(requireContext(), attr, fallBackColor)

fun Dialog.resolveColor(@AttrRes attr: Int, fallBackColor: Int = 0) =
    AppThemeUtil.resolveColor(context, attr, fallBackColor)
