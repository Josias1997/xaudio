 ...
 */
package com.fullstapp.splitit.service
...
import com.fullstapp.splitit.*
import com.fullstapp.splitit.activities.LockScreenActivity
import com.fullstapp.splitit.appwidgets.*
import com.fullstapp.splitit.auto.AutoMediaIDHelper
import com.fullstapp.splitit.auto.AutoMusicProvider
import com.fullstapp.splitit.extensions.showToast
import com.fullstapp.splitit.extensions.toMediaSessionQueue
import com.fullstapp.splitit.extensions.uri
import com.fullstapp.splitit.glide.BlurTransformation
import com.fullstapp.splitit.glide.RetroGlideExtension.getSongModel
import com.fullstapp.splitit.glide.RetroGlideExtension.songCoverOptions
import com.fullstapp.splitit.helper.ShuffleHelper.makeShuffleList
import com.fullstapp.splitit.model.Song
import com.fullstapp.splitit.model.Song.Companion.emptySong
import com.fullstapp.splitit.model.smartplaylist.AbsSmartPlaylist
import com.fullstapp.splitit.providers.HistoryStore
import com.fullstapp.splitit.providers.MusicPlaybackQueueStore
import com.fullstapp.splitit.providers.SongPlayCountStore
import com.fullstapp.splitit.service.notification.PlayingNotification
import com.fullstapp.splitit.service.notification.PlayingNotificationClassic
import com.fullstapp.splitit.service.notification.PlayingNotificationImpl24
import com.fullstapp.splitit.service.playback.Playback
import com.fullstapp.splitit.service.playback.Playback.PlaybackCallbacks
import com.fullstapp.splitit.util.MusicUtil
import com.fullstapp.splitit.util.MusicUtil.toggleFavorite
import com.fullstapp.splitit.util.PackageValidator
import com.fullstapp.splitit.util.PreferenceUtil.crossFadeDuration
import com.fullstapp.splitit.util.PreferenceUtil.isAlbumArtOnLockScreen
import com.fullstapp.splitit.util.PreferenceUtil.isBluetoothSpeaker
import com.fullstapp.splitit.util.PreferenceUtil.isBlurredAlbumArt
import com.fullstapp.splitit.util.PreferenceUtil.isClassicNotification
import com.fullstapp.splitit.util.PreferenceUtil.isHeadsetPlugged
import com.fullstapp.splitit.util.PreferenceUtil.isLockScreen
import com.fullstapp.splitit.util.PreferenceUtil.isPauseOnZeroVolume
import com.fullstapp.splitit.util.PreferenceUtil.playbackPitch
import com.fullstapp.splitit.util.PreferenceUtil.playbackSpeed
import com.fullstapp.splitit.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import com.fullstapp.splitit.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
import com.fullstapp.splitit.volume.AudioVolumeObserver
import com.fullstapp.splitit.volume.OnAudioVolumeChangedListener
...
class MusicService : MediaBrowserServiceCompat(),
    ...
    companion object {
        ...
        const val RETRO_MUSIC_PACKAGE_NAME = "com.eidogs.xaudio"
