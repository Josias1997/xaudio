...
import com.fullstapp.splitit.activities.ErrorActivity
import com.fullstapp.splitit.activities.MainActivity
import com.fullstapp.splitit.appshortcuts.DynamicShortcutManager
import com.fullstapp.splitit.billing.BillingManager
import com.fullstapp.splitit.helper.WallpaperAccentManager
    ...
    override fun onCreate() {
        ...
        if (!ThemeStore.isConfigured(this, 3)) {
            ThemeStore.editTheme(this)
                .accentColorRes(com.fullstapp.appthemehelper.R.color.md_deep_purple_A200)
