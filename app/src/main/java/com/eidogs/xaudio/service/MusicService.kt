...
import com.eidogs.xaudio.*
import com.eidogs.xaudio.activities.LockScreenActivity
import com.eidogs.xaudio.appwidgets.*
import com.eidogs.xaudio.auto.AutoMediaIDHelper
import com.eidogs.xaudio.auto.AutoMusicProvider
import com.eidogs.xaudio.extensions.showToast
import com.eidogs.xaudio.extensions.toMediaSessionQueue
import com.eidogs.xaudio.extensions.uri
import com.eidogs.xaudio.glide.BlurTransformation
import com.eidogs.xaudio.glide.RetroGlideExtension.getSongModel
import com.eidogs.xaudio.glide.RetroGlideExtension.songCoverOptions
import com.eidogs.xaudio.helper.ShuffleHelper.makeShuffleList
import com.eidogs.xaudio.model.Song
import com.eidogs.xaudio.model.Song.Companion.emptySong
import com.eidogs.xaudio.model.smartplaylist.AbsSmartPlaylist
import com.eidogs.xaudio.providers.HistoryStore
import com.eidogs.xaudio.providers.MusicPlaybackQueueStore
import com.eidogs.xaudio.providers.SongPlayCountStore
import com.eidogs.xaudio.service.notification.PlayingNotification
import com.eidogs.xaudio.service.notification.PlayingNotificationClassic
import com.eidogs.xaudio.service.notification.PlayingNotificationImpl24
import com.eidogs.xaudio.service.playback.Playback
import com.eidogs.xaudio.service.playback.Playback.PlaybackCallbacks
import com.eidogs.xaudio.util.MusicUtil
import com.eidogs.xaudio.util.MusicUtil.toggleFavorite
import com.eidogs.xaudio.util.PackageValidator
import com.eidogs.xaudio.util.PreferenceUtil.crossFadeDuration
import com.eidogs.xaudio.util.PreferenceUtil.isAlbumArtOnLockScreen
import com.eidogs.xaudio.util.PreferenceUtil.isBluetoothSpeaker
import com.eidogs.xaudio.util.PreferenceUtil.isBlurredAlbumArt
import com.eidogs.xaudio.util.PreferenceUtil.isClassicNotification
import com.eidogs.xaudio.util.PreferenceUtil.isHeadsetPlugged
import com.eidogs.xaudio.util.PreferenceUtil.isLockScreen
import com.eidogs.xaudio.util.PreferenceUtil.isPauseOnZeroVolume
import com.eidogs.xaudio.util.PreferenceUtil.playbackPitch
import com.eidogs.xaudio.util.PreferenceUtil.playbackSpeed
import com.eidogs.xaudio.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import com.eidogs.xaudio.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
import com.eidogs.xaudio.volume.AudioVolumeObserver
import com.eidogs.xaudio.volume.OnAudioVolumeChangedListener
