...
import com.eidogs.xaudio.databinding.DialogSleepTimerBinding
import com.eidogs.xaudio.extensions.addAccentColor
...
import com.eidogs.xaudio.service.MusicService.Companion.ACTION_PENDING_QUIT
            ...
            if (PreferenceUtil.nextSleepTimerElapsedRealTime > System.currentTimeMillis()) {
                ...
                setPositiveButton(R.string.action_set) { _, _ ->
                    ...
                    if(pi != null) {
                        ...
                        Toast.makeText(requireContext(), getString(R.string.sleep_timer_canceled), Toast.LENGTH_SHORT).show()
                    }
                }
            }
