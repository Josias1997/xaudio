...
import com.eidogs.xaudio.activities.ErrorActivity
import com.eidogs.xaudio.activities.MainActivity
import com.eidogs.xaudio.appshortcuts.DynamicShortcutManager
import com.eidogs.xaudio.billing.BillingManager
import com.eidogs.xaudio.helper.WallpaperAccentManager
    ...
    override fun onCreate() {
        ...
        if (!ThemeStore.isConfigured(this, 3)) {
            ThemeStore.editTheme(this)
                .accentColorRes(com.eidogs.appthemehelper.R.color.md_deep_purple_A200)
