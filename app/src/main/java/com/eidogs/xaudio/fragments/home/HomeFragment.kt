 ...
 *
 */
package com.eidogs.xaudio.fragments.home
...
import com.eidogs.xaudio.adapter.HomeAdapter
import com.eidogs.xaudio.databinding.FragmentHomeBinding
import com.eidogs.xaudio.dialogs.CreatePlaylistDialog
import com.eidogs.xaudio.dialogs.ImportPlaylistDialog
import com.eidogs.xaudio.extensions.accentColor
import com.eidogs.xaudio.extensions.dip
import com.eidogs.xaudio.extensions.elevatedAccentColor
import com.eidogs.xaudio.extensions.setUpMediaRouteButton
import com.eidogs.xaudio.fragments.ReloadType
import com.eidogs.xaudio.fragments.base.AbsMainActivityFragment
import com.eidogs.xaudio.glide.RetroGlideExtension
import com.eidogs.xaudio.glide.RetroGlideExtension.profileBannerOptions
import com.eidogs.xaudio.glide.RetroGlideExtension.songCoverOptions
import com.eidogs.xaudio.glide.RetroGlideExtension.userProfileOptions
...
import com.eidogs.xaudio.util.PreferenceUtil.userName
...
class HomeFragment :
    ...
    override fun onStart() {
        super.onStart()
        initAd(binding.homeAdview!!)
        initAd(binding.homeContentAdview)
    }
    ...
    private fun setupTitle() {
        ...
        val appName = "<font color=$hexColor>Xaudio</font>".parseAsHtml()
