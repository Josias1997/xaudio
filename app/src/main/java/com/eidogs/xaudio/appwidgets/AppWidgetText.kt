 ...
 *
 */
package com.eidogs.xaudio.appwidgets
...
import com.eidogs.xaudio.appwidgets.base.BaseAppWidget
import com.eidogs.xaudio.extensions.getTintedDrawable
import com.eidogs.xaudio.service.MusicService
import com.eidogs.xaudio.service.MusicService.Companion.ACTION_REWIND
import com.eidogs.xaudio.service.MusicService.Companion.ACTION_SKIP
import com.eidogs.xaudio.service.MusicService.Companion.ACTION_TOGGLE_PAUSE
...
class AppWidgetText : BaseAppWidget() {
    override fun defaultAppWidget(context: Context, appWidgetIds: IntArray) {
        ...
        appWidgetView.setImageViewBitmap(
            ...
            context.getTintedDrawable(
                R.drawable.ic_skip_next, ContextCompat.getColor(
                    context, com.eidogs.appthemehelper.R.color.md_white_1000
                )
            ).toBitmap()
        )
        appWidgetView.setImageViewBitmap(
        ...
        appWidgetView.setImageViewBitmap(
            ...
            context.getTintedDrawable(
                R.drawable.ic_play_arrow_white_32dp, ContextCompat.getColor(
                    context, com.eidogs.appthemehelper.R.color.md_white_1000
                )
            ).toBitmap()
        )
        ...
        appWidgetView.setTextColor(
            R.id.title,
            ContextCompat.getColor(context, com.eidogs.appthemehelper.R.color.md_white_1000)
        )
        appWidgetView.setTextColor(
            R.id.text,
            ContextCompat.getColor(context, com.eidogs.appthemehelper.R.color.md_white_1000)
    ...
    override fun performUpdate(service: MusicService, appWidgetIds: IntArray?) {
        ...
        appWidgetView.setImageViewBitmap(
            ...
            service.getTintedDrawable(
                playPauseRes, ContextCompat.getColor(
                    service, com.eidogs.appthemehelper.R.color.md_white_1000
                )
            ).toBitmap()
        )
        appWidgetView.setImageViewBitmap(
            ...
            service.getTintedDrawable(
                ...
                ContextCompat.getColor(
                    service,
                    com.eidogs.appthemehelper.R.color.md_white_1000
                )
            ).toBitmap()
        )
        appWidgetView.setImageViewBitmap(
