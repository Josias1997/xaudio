...
object Constants {
    ...
    const val RATE_ON_GOOGLE_PLAY =
        "https://play.google.com/store/apps/details?id=com.eidogs.xaudio"
    const val WEBSITE = "https://xaudio.framer.ai"
    const val TELEGRAM_CHANGE_LOG = "https://t.me/"
    const val USER_PROFILE = "profile.jpg"
    const val USER_BANNER = "banner.jpg"
    const val APP_INSTAGRAM_LINK = "https://www.instagram.com/"
    const val APP_TELEGRAM_LINK = "https://t.me/"
...
const val STEMS_TYPE = "stems_type"